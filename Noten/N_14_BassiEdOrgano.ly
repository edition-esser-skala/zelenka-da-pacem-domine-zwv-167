...
BassiOrgano = {
	...
	\relative c {
		...
		b b b b es, es es es
		b' f b, g' es4 f
		b16-\markup { \anmerkung "Tutti Registri" } b a a g g f es d8 d es es %60
		es es es es f f f f
		g g es es f f f f
		b b b b es, es es es
		b f' b es, f4 f,
		b4\fermata \tempoDaPacemE r r2 %65
		b'8-\markup { \anmerkung "Registri soliti" } b, b b b b b b
		g' g, g g g g g g
		es'' es, es es e e e e
		f f, f f f' f f f
	...
	\relative c {
		...
		\tempoQuia b'4-\markup { \anmerkung "staccato sempre" } d, es f \noBreak
		r8 b, b' b a a16 a g4
		es f b,8 b' b b %75
...
BassFigures = \figuremode {
	...
	<5 _!>8 <\t \t> <6>4 <6 5> <5 _!>8 <\t \t>
	<5 3>4 <6> <6 [_!]> <[5!] _+>
	<5 3> <6> <[5!] _+>4. \bassFigureExtendersOn <5! _+>8 \bassFigureExtendersOff
	<5 3>4 <[6]> <[5!] _+> <6> %40
	<6 5 _!> <[5!] _+> <5 3> <\t \t>
	<5 _!> <6> <6 [_-]> <5 _!>
	<5 3> <\t \t> <5 3> <6>8 <\t>
	...
	<9 3> <8> <9 3> <8> %80
	<5 4> <\t _!> r2
	<9 7>4 <8 6>8 <[7] [5]> <9 7>4 <[8] [6]>8 <[7] [5]>
	<5 3>4. <6 5>8 <5 4>4 <\t _!>
	r <6> <6 5> <_!>
	r8 <5 3>4. <6>4 q %85
	<6 5> <5 _!> <5 3> <\t \t>
	...
	<5 [_-]>4.. \bassFigureExtendersOn <5 _->16 <5\! _!>4.. <5 _!>16 \bassFigureExtendersOff
	r4. <_->8 <5 _!>2
	r4 <6> <_-> <5 _!> %95
	r8 <5 3> r4 <6> q
	<6 5> <5 3> r8 <5 3> <\t \t>4
